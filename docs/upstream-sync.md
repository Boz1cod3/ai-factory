...
This repository (`Boz1cod3/ai-factory`) is a modernized fork of [lee-to/ai-factory](https://github.com/lee-to/ai-factory), featuring first-class support for **Google Antigravity 2.0** (Agent Skills layout, native agents (.agents/agents/), MCP configuration, and rule triggers).
...
1. **Native Agents**: Located in `subagents/antigravity/agents/*.md` and installed into `.agents/agents/` — upstream has no conflicting files in this directory.
...
4. Title: `feat(antigravity): modernize to Antigravity 2.0 with skills, MCP, rule triggers, and native agents`.
